 function get(id) {
    ...
    function validate()
    {
        ...
        if(get("email").value == "")
         ...
         if(get("code").value == "")
        {
            get("err_msg_code").innerHTML="code num required from JS";
            get("err_msg_code").style.color="red";
            get("code").style.border="3px solid red";
            haserror=true;
            
        }
        else if(get("code").value < 5){
            
            get("err_msg_code").innerHTML=" code num can't contain less than 5 charecter from JS";
            get("err_msg_code").style.color="red";
            get("code").style.border="3px solid red";
            haserror=true;
        }
        else{
            get("code").style.border="3px solid green";
