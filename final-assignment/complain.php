...
if (isset($_POST['fname']) && isset($_POST['email']) && isset($_POST['address']))
      {
        ...
        $result_result=mysqli_query($result,"insert into complain values(NULL,'$fname','$email','$address') ");
...
.btn:hover
{
  ...
  <body>
  	...
  	<form method="post"  >
  		...
  		<textarea class="txtarea" rows="4" cols="50" name="address" > </textarea> <br> <br>
