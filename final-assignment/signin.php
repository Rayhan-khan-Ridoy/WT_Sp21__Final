...
<body class="main-bg">
        <div class="login-container text-c animated flipInX">
                <div>
                    ...
                    <h3 class="text-whitesmoke">Sign In Here</h3>
                    <p class="text-whitesmoke">Sign In</p>
                <div class="container-content">
                    <form class="margin-t" method="post" action="loginDB.php">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Username" name="username">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" placeholder="*****" name="pass"> <br>
                        </div>
                        <button type="submit" class="form-button button-l margin-b">Sign In</button>
                        <p class="text-whitesmoke text-center"><small>Do not have an account?</small></p>
                        <a class="text-darkyellow" href="signup.php"><small>Sign Up</small></a> <br> <br>
